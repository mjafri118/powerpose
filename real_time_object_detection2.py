...
class PowerPose:
	...
	def sampleplot(self):
		...
		test_area = np.array([64350, 64960, 65408, 65184, 64512, 64960, 64960, 65184, 65408, 65632, 65184, 65408, 65785, 66304, 66600, 66375, 63450, 59175, 53058, 47008, 44460, 40906, 42262, 43130,
